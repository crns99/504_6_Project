...
<body>
	<div>
		...
		<header id="header">
			<jsp:include page="../../com/top.jsp" >
				<jsp:param name="title" value="자유게시판 등록"/>
			</jsp:include>                     
		</header>
		<!-- //#header --> 
		<div class="container">
			<!-- s : content -->
			<section id="content">
				<form name="write_form"  action="<c:url value='/board/free/boardWrite.do'/>" method="post">
					<!-- 검색조건 유지 -->
					...
					<table class="tblForm">
						<tbody>
							...
							<tr>
								<th><span>*작성자</span></th>
								<td style="text-align:left;"><input type="text" style="width:700px;" name="reg_user_id" value="" maxlength="255" REQUIRED hname="작성자"/></td>
							</tr>
							<tr>
								<th><span>*내용</span></th>
	...
	<script type="text/javaScript" language="javascript">
		...
		function fn_save(){
			var frm = document.write_form;
			frm.action =  "<c:url value='/board/free/boardWriteSave.do'/>";
