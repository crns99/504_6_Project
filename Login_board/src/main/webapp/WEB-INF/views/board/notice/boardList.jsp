...
<body>
	<div>
		...
		<div class="container">
			<!-- s : content -->
			<section id="content">
				<form name="frm" id="frm" action="<c:url value='/board/notice/boardList.do'/>" method="post">
				        ...
				        <c:forEach items="${resultList}" var="resultInfo" varStatus="status">
				        	<tr>
				                <td>
				                    ...
				                    <a href="javascript:fn_get_detail_view('${resultInfo.no}');"><c:out value="${paginationInfo.totalRecordCount+1 - ((searchVO.pageIndex-1) * searchVO.pageSize + status.count)}"/></a>
	...
	<script type="text/javascript">
	    ...
	    function fn_get_detail_view(boardNo){
			...
			frm.no.value = boardNo;
			frm.target= "_self";
			frm.action="<c:url value='/baord/notice/BoardDetail.do'/>";
			frm.submit();
		}
	    /* ********************************************************
	     * 등록 처리 함수
