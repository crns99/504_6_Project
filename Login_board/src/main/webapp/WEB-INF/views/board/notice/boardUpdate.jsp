...
<body>
	<div>
		...
		<header id="header">
			<jsp:include page="../../com/top.jsp" >
				<jsp:param name="title" value="게시판 수정 페이지"/>
			</jsp:include>                     
		</header>
		<!-- //#header --> 
		...
		<div class="container">
			<!-- s : content -->
			<section id="content">
				<form name="update_form"  id="boardUpdateForm" action="<c:url value='/baord/notice/boardUpdate.do'/>" method="post">
				    ...
				    <table class="tblForm">
							...
							<tr>
								...
								<td style="text-align:left;">
									<textarea name="content" id="editorTxt" rows="20" cols="10" style="width: 700px" REQUIRED hname="내용">${boardInfo.content}</textarea></td>
							</tr>
						</tbody>
					</table>
	...
	<script type="text/javaScript" language="javascript">
		 ...
		 ******************************************************** */
		 function fn_update(){
			var frm = document.update_form;
			frm.action = "<c:url value='/board/notice/saveboardUpdate.do'/>";
