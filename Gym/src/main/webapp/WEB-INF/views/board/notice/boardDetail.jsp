...
<body>
	<div>
		...
		<div class="container">
			<!-- s : content -->
			<section id="content">
				<form name="detail_form"  id="boardDetailForm" action="<c:url value='/sym/bat/getBatchOpert.do'/>" method="post">
				    ...
				    <table class="tblForm">
						<tbody>
							<tr>
								<th><span>제목</span></th>
								<td style="text-align:left;"><c:out value="${resultInfo.title}" escapeXml="false" /></td>
							</tr>
							<tr>
								<th><span>작성일자</span></th>
								<td style="text-align:left;"><c:out value="${resultInfo.regdate}" escapeXml="false" /></td>
							</tr>
							<tr>
								<th><span>작성자</span></th>
								<td style="text-align:left;"><c:out value="${resultInfo.id}" escapeXml="false" /></td>
							</tr>
							<tr>
								<th><span>내용</span></th>
								<td style="text-align:left;"><c:out value="${resultInfo.content}" escapeXml="false" /></td>
							</tr>
						</tbody>
					</table>
	...
	<script type="text/javaScript" language="javascript">
		...
		/* function fn_update_view(){
			...
			frm.action = "<c:url value='/sym/bat/.do'/>";
			frm.submit();
		} */
		/* ********************************************************
		 * 삭제 처리
