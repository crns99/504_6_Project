...
import com.board.util.PaginationInfo;
...
//	글 작성
	...
	public String boardDetail(@ModelAttribute("searchVO") BoardVO searchVO, ModelMap model) throws Exception {
		/*
		 * log.debug(" 조회조건 : {}", searchVO); BoardVO result =
		 * boardService.boardDetail(searchVO); model.addAttribute("resultInfo", result);
